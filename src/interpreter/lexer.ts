import { Token, TokenError, LexerOutput } from './Token';

export default function lexer(input: string): LexerOutput {
    ...
    lines.forEach((line, lineNumber) => {
        ...
        while (position < line.length) {
            ...
            if (!matched) {
                ...
                unknownCharacters.push(new TokenError('Unknown character', lineNumber + 1, position, line[position - 1]));
            }
        }
